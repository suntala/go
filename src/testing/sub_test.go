...
// =================== TEMPORARILY KEEPING T.OUTPUT TESTS TO DEMONSTRATE BEHAVIOR HERE ===================
...
func TestWriterUsingSlogHandler(t *T) {
...
func TestShouldWriteEntireMultipleLineInputWhenSubtestIsDone(t *T) {
